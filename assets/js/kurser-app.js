(() => {
  ...
  /* =========================================================
     VIDEO-OVERRIDES
     SharePoint-video öppnas i ny flik (inte iframe i GitHub Pages)
     ========================================================= */
  const VIDEO_OVERRIDES = {
    kurs01_modul01:
      "https://halmstad.sharepoint.com/:v:/s/TestavTeammedbibliotek/IQABWSDYJjqPQoIfGi0z0Ou9AcMxF5Oy4PrqVL_O-_kNaGM",
    kurs01_modul02:
      "https://halmstad.sharepoint.com/:v:/s/TestavTeammedbibliotek/IQD71mP6Qek0TLIsqv9_dLTZAbF0Ejm0iqytgK-HSoVan30",
    kurs01_modul03:
      "https://halmstad.sharepoint.com/:v:/s/TestavTeammedbibliotek/IQCRb0ptY9iCQJThz0KP2dPMAfjC3fxkyC1F9g3bhnclEwM",
    kurs01_modul04:
      "https://halmstad.sharepoint.com/:v:/s/TestavTeammedbibliotek/IQAQSNKAUbYpQLkt7bg4jpcrAWi_WYKLOb9TLMNIG6zl5BI"
  };
  ...
  /* =========================================================
     VIDEO-RENDERING
     SharePoint blockeras i extern iframe → öppna i ny flik
     Microsoft beskriver detta som avsiktligt beteende. 2](https://portal.tforcefreight.com/)
     ========================================================= */
  function renderVideo(videoBox, module) {
    ...
    if (isSharePointUrl(videoUrl)) {
      videoBox.innerHTML = `
        <div class="note-box">
          Den här videon kan inte visas direkt i portalen eftersom SharePoint blockerar extern iframe-visning. [1](https://docs.github.com/pages)[2](https://portal.tforcefreight.com/)
